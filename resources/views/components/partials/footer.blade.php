...
<footer class="bg-black dark:bg-gray-900 pt-[10px] w-ful h-full">
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a href="" class=" flex items-center gap-[25px]">
                <p href="/" class="text-lg font-bold text-white ">{{$siteName}}  </p>
            </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-white  uppercasetext-white ">Follow us</h2>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" class="hover:underline">Company White Site Game</a>
          </span>
